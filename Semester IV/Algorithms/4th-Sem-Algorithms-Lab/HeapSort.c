/*
Question: Write a C program to perform heap sort.
Instructions: # To sort elements in increasing order
              Input will be the number of elements and unsorted array
              For example:
