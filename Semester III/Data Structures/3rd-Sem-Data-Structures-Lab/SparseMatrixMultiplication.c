/*
Question: Write a C program to multiply two sparese matrices.
Program Overview: a. The size of the first matrix is defined and the user-input elements are inserted. Parallely, the matrix is stores in sparse form.
                  b. The size of the second matrix is defined anf the user-input elements are inserted. Parallely, the matrix is stored in sparse form.
                  c. The multiplication operation is performed on the matrices, both in their sparse form.
                  d. The multiplied result is displayed on-screen in sparse-form only.
*/
